...
export default function Contact() {
  ...
  return (
    <section id="contact" className="scroll-mt-24 py-24 sm:py-32">
      <SectionHeading
        eyebrow="05 · Contact"
        title="Need one engineer across"
        accent="more than one layer?"
        description="Tell me what you’re building, where delivery is getting stuck, and what needs to ship. I’ll reply with a concrete next step."
      />
      <div className="mt-14 grid overflow-hidden rounded-[2rem] border border-border/70 bg-card shadow-2xl shadow-black/5 lg:grid-cols-[.78fr_1.22fr]">
        <Reveal direction="right" className="h-full">
          <div className="relative flex h-full min-h-[420px] flex-col justify-between overflow-hidden bg-zinc-950 p-7 text-white sm:p-10">
            ...
            <div className="relative space-y-4">
              <a
                ...
                className="flex items-center justify-between rounded-2xl border border-white/10 bg-white/[.045] p-4 transition hover:bg-white/[.08]"
              >
              ...
              <div className="flex items-center gap-3 px-4 text-sm text-white/60">
          ...
          >
            ...
            <label className="grid gap-2 text-sm font-medium">
              ...
              <input
                ...
                name="subject"
                className="h-12 rounded-xl border border-border bg-background px-4 outline-none transition focus:border-primary/60 focus:ring-4 focus:ring-primary/10"
                placeholder="Product, website, mobile app…"
              />
            </label>
            <label className="grid gap-2 text-sm font-medium">
              Project context
              <textarea
                ...
                placeholder="The goal, the current blocker, and your ideal timeline."
              />
            </label>
            <input
              name="website"
