...
export default function HeroClient() {
  ...
  return (
    // Main grid container
    <section ref={containerRef} className="w-full max-w-7xl mx-auto grid grid-cols-2 lg:gap-24 gap-5 place-content-center px-4 min-h-[calc(100vh-10rem)] relative">
