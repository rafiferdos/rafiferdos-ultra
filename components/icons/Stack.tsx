...
function IconStackPerspective({ size = '24px', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <g fill="none" className="nc-icon-wrapper">
        <path
          ...
          fill="url(#oqcgdjwijmq-1752500502804-4744372_stack-perspective_existing_0_9j5b6fsew)"
          data-glass="origin"
          mask="url(#oqcgdjwijmq-1752500502804-4744372_stack-perspective_mask_npad53mc0)"
        ></path>
        <path
          d="M7 7.74759C7 5.43142 7 4.27333 7.4746 3.45742C7.89096 2.74164 8.54761 2.19667 9.32786 1.91935C10.2173 1.60324 11.3555 1.81666 13.632 2.2435L17.7794 3.02115C19.6372 3.36948 20.5662 3.54365 21.2618 4.02058C21.8752 4.44109 22.3592 5.02427 22.6594 5.70462C23 6.47626 23 7.42135 23 9.31153V13.2524C23 15.5686 23 16.7267 22.5254 17.5426C22.109 18.2584 21.4524 18.8033 20.6721 19.0807C19.7827 19.3968 18.6445 19.1833 16.368 18.7565L12.2206 17.9789C10.3627 17.6305 9.43385 17.4563 8.73819 16.9794C8.12482 16.5589 7.64083 15.9757 7.34056 15.2954C7 14.5237 7 13.5787 7 11.6885V7.74759Z"
          fill="url(#oqcgdjwijmq-1752500502804-4744372_stack-perspective_existing_0_9j5b6fsew)"
          data-glass="clone"
          filter="url(#oqcgdjwijmq-1752500502804-4744372_stack-perspective_filter_ql7gyis96)"
          clipPath="url(#oqcgdjwijmq-1752500502804-4744372_stack-perspective_clipPath_92jk82aca)"
        ></path>
        <path
          ...
          fill="url(#oqcgdjwijmq-1752500502804-4744372_stack-perspective_existing_1_4m8a1fwmn)"
          data-glass="blur"
        ></path>
        <path
          ...
          fill="url(#oqcgdjwijmq-1752500502804-4744372_stack-perspective_existing_2_gj8gaetpw)"
        ></path>
        <defs>
          <linearGradient
            id="oqcgdjwijmq-1752500502804-4744372_stack-perspective_existing_0_9j5b6fsew"
            x1="15"
            y1="1"
            x2="15"
            y2="20"
          ...
          <linearGradient
            id="oqcgdjwijmq-1752500502804-4744372_stack-perspective_existing_1_4m8a1fwmn"
            x1="9"
            y1="4"
            x2="9"
            y2="23"
          ...
          <linearGradient
            id="oqcgdjwijmq-1752500502804-4744372_stack-perspective_existing_2_gj8gaetpw"
            x1="9"
            y1="4.768"
            x2="9"
            y2="14.881"
          ...
          <filter
            id="oqcgdjwijmq-1752500502804-4744372_stack-perspective_filter_ql7gyis96"
            x="-100%"
            y="-100%"
            width="400%"
            height="400%"
          ...
          <clipPath id="oqcgdjwijmq-1752500502804-4744372_stack-perspective_clipPath_92jk82aca">
            <path
              d="M1 10.7476C1 8.43142 1 7.27333 1.4746 6.45742C1.89096 5.74164 2.54761 5.19667 3.32786 4.91935C4.21727 4.60324 5.35552 4.81666 7.63201 5.2435L11.7794 6.02115C13.6372 6.36948 14.5662 6.54365 15.2618 7.02058C15.8752 7.44109 16.3592 8.02427 16.6594 8.70462C17 9.47626 17 10.4213 17 12.3115V16.2524C17 18.5686 17 19.7267 16.5254 20.5426C16.109 21.2584 15.4524 21.8033 14.6721 22.0807C13.7827 22.3968 12.6445 22.1833 10.368 21.7565L6.22056 20.9789C4.36275 20.6305 3.43385 20.4563 2.73819 19.9794C2.12482 19.5589 1.64083 18.9757 1.34056 18.2954C1 17.5237 1 16.5787 1 14.6885V10.7476Z"
              fill="url(#oqcgdjwijmq-1752500502804-4744372_stack-perspective_existing_1_4m8a1fwmn)"
            ></path>
          </clipPath>
          <mask id="oqcgdjwijmq-1752500502804-4744372_stack-perspective_mask_npad53mc0">
...
export default IconStackPerspective
