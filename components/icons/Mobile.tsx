...
function IconSquareChartLine({ size = '24px', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <g fill="none" className="nc-icon-wrapper">
        <path
          ...
          fill="url(#3wylfk2ua04-1752500502804-9183447_square-chart-line_existing_0_ko3hky3pd)"
          data-glass="origin"
          mask="url(#3wylfk2ua04-1752500502804-9183447_square-chart-line_mask_66dhv0iub)"
        ></path>
        <path
          d="M3 8.4C3 6.15979 3 5.03968 3.43597 4.18404C3.81947 3.43139 4.43139 2.81947 5.18404 2.43597C6.03968 2 7.15979 2 9.4 2H14.6C16.8402 2 17.9603 2 18.816 2.43597C19.5686 2.81947 20.1805 3.43139 20.564 4.18404C21 5.03968 21 6.15979 21 8.4V11.6C21 13.8402 21 14.9603 20.564 15.816C20.1805 16.5686 19.5686 17.1805 18.816 17.564C17.9603 18 16.8402 18 14.6 18H9.4C7.15979 18 6.03968 18 5.18404 17.564C4.43139 17.1805 3.81947 16.5686 3.43597 15.816C3 14.9603 3 13.8402 3 11.6V8.4Z"
          fill="url(#3wylfk2ua04-1752500502804-9183447_square-chart-line_existing_0_ko3hky3pd)"
          data-glass="clone"
          filter="url(#3wylfk2ua04-1752500502804-9183447_square-chart-line_filter_kwhh3qkup)"
          clipPath="url(#3wylfk2ua04-1752500502804-9183447_square-chart-line_clipPath_lvme5u893)"
        ></path>
        <path
          ...
          fill="url(#3wylfk2ua04-1752500502804-9183447_square-chart-line_existing_1_vl0j8v33y)"
          data-glass="blur"
        ></path>
        <path
          ...
          fill="url(#3wylfk2ua04-1752500502804-9183447_square-chart-line_existing_2_o3c96osrf)"
        ></path>
        <defs>
          <linearGradient
            id="3wylfk2ua04-1752500502804-9183447_square-chart-line_existing_0_ko3hky3pd"
            x1="12"
            y1="2"
            x2="12"
            y2="18"
          ...
          <linearGradient
            id="3wylfk2ua04-1752500502804-9183447_square-chart-line_existing_1_vl0j8v33y"
            x1="12"
            y1="9.361"
            x2="12"
            y2="22"
          ...
          <linearGradient
            id="3wylfk2ua04-1752500502804-9183447_square-chart-line_existing_2_o3c96osrf"
            x1="12"
            y1="9.361"
            x2="12"
            y2="16.68"
          ...
          <filter
            id="3wylfk2ua04-1752500502804-9183447_square-chart-line_filter_kwhh3qkup"
            x="-100%"
            y="-100%"
            width="400%"
            height="400%"
          ...
          <clipPath id="3wylfk2ua04-1752500502804-9183447_square-chart-line_clipPath_lvme5u893">
            <path
              d="M9.7666 9.87523C9.48873 9.39536 8.87716 9.21774 8.3916 9.48558L3.55455 12.1452C2.59573 12.6724 2 13.6798 2 14.774V16.5998V16.6031C2 18.8398 2 18.9605 2.43555 19.8157C2.81896 20.5681 3.43117 21.1802 4.18359 21.5637C5.03924 21.9997 6.16018 22.0002 8.40039 22.0002H15.5996C17.8398 22.0002 18.9608 21.9997 19.8164 21.5637C20.5688 21.1802 21.181 20.5681 21.5645 19.8157C22 18.9605 22 17.8408 22 15.6031V15.5998V10.6428C21.9999 9.89353 21.2089 9.41219 20.5488 9.76683C18.0694 11.099 14.7916 12.9434 13.2812 13.7971C12.8177 14.0591 12.2304 13.9141 11.9473 13.4631C11.3884 12.5728 10.4754 11.0997 9.7666 9.87523Z"
              fill="url(#3wylfk2ua04-1752500502804-9183447_square-chart-line_existing_1_vl0j8v33y)"
            ></path>
          </clipPath>
          <mask id="3wylfk2ua04-1752500502804-9183447_square-chart-line_mask_66dhv0iub">
...
export default IconSquareChartLine
